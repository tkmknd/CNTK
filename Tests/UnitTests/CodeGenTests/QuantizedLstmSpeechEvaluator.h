...
namespace CNTK
{
class QuantizedLstmSpeechEvaluator final
{
public:
...
const std::vector<short> get_parameter6() const { return m_Parameter6; }
void set_parameter6(const std::vector<float>&& v) { auto r = Quantize<float, short>(v, 3); m_Parameter6 = r.first; m_step_Parameter6 = r.second; };
const std::vector<short> get_parameter8() const { return m_Parameter8; }
void set_parameter8(const std::vector<float>&& v) { auto r = Quantize<float, short>(v, 3); m_Parameter8 = r.first; m_step_Parameter8 = r.second; };
const std::vector<short> get_parameter10() const { return m_Parameter10; }
void set_parameter10(const std::vector<float>&& v) { auto r = Quantize<float, short>(v, 3); m_Parameter10 = r.first; m_step_Parameter10 = r.second; };
...
const std::vector<short> get_parameter17() const { return m_Parameter17; }
void set_parameter17(const std::vector<float>&& v) { auto r = Quantize<float, short>(v, 3); m_Parameter17 = r.first; m_step_Parameter17 = r.second; };
const std::vector<short> get_parameter19() const { return m_Parameter19; }
void set_parameter19(const std::vector<float>&& v) { auto r = Quantize<float, short>(v, 3); m_Parameter19 = r.first; m_step_Parameter19 = r.second; };
...
const std::vector<short> get_parameter22() const { return m_Parameter22; }
void set_parameter22(const std::vector<float>&& v) { auto r = Quantize<float, short>(v, 3); m_Parameter22 = r.first; m_step_Parameter22 = r.second; };
...
const std::vector<short> get_parameter29() const { return m_Parameter29; }
void set_parameter29(const std::vector<float>&& v) { auto r = Quantize<float, short>(v, 3); m_Parameter29 = r.first; m_step_Parameter29 = r.second; };
const std::vector<short> get_parameter31() const { return m_Parameter31; }
void set_parameter31(const std::vector<float>&& v) { auto r = Quantize<float, short>(v, 3); m_Parameter31 = r.first; m_step_Parameter31 = r.second; };
...
const std::vector<short> get_parameter34() const { return m_Parameter34; }
void set_parameter34(const std::vector<float>&& v) { auto r = Quantize<float, short>(v, 3); m_Parameter34 = r.first; m_step_Parameter34 = r.second; };
...
const std::vector<short> get_parameter41() const { return m_Parameter41; }
void set_parameter41(const std::vector<float>&& v) { auto r = Quantize<float, short>(v, 3); m_Parameter41 = r.first; m_step_Parameter41 = r.second; };
const std::vector<short> get_parameter43() const { return m_Parameter43; }
void set_parameter43(const std::vector<float>&& v) { auto r = Quantize<float, short>(v, 3); m_Parameter43 = r.first; m_step_Parameter43 = r.second; };
...
const std::vector<short> get_parameter46() const { return m_Parameter46; }
void set_parameter46(const std::vector<float>&& v) { auto r = Quantize<float, short>(v, 3); m_Parameter46 = r.first; m_step_Parameter46 = r.second; };
...
const std::vector<short> get_parameter53() const { return m_Parameter53; }
void set_parameter53(const std::vector<float>&& v) { auto r = Quantize<float, short>(v, 3); m_Parameter53 = r.first; m_step_Parameter53 = r.second; };
const std::vector<short> get_parameter55() const { return m_Parameter55; }
void set_parameter55(const std::vector<float>&& v) { auto r = Quantize<float, short>(v, 3); m_Parameter55 = r.first; m_step_Parameter55 = r.second; };
...
auto b_Parameter6 = Halide::Buffer<short>(m_Parameter6.data(), 256, 9404, "Parameter6");
Halide::Func f_Parameter6("f_Parameter6"); f_Parameter6(var1, var2) = b_Parameter6(var1, var2);
Halide::Func f_step_Parameter6("f_step_Parameter6"); f_step_Parameter6() = m_step_Parameter6;
std::vector<Halide::Func> Parameter6 { f_Parameter6, f_step_Parameter6 };


auto b_Parameter8 = Halide::Buffer<short>(m_Parameter8.data(), 512, 256, "Parameter8");
Halide::Func f_Parameter8("f_Parameter8"); f_Parameter8(var1, var2) = b_Parameter8(var1, var2);
Halide::Func f_step_Parameter8("f_step_Parameter8"); f_step_Parameter8() = m_step_Parameter8;
std::vector<Halide::Func> Parameter8 { f_Parameter8, f_step_Parameter8 };


auto b_Parameter10 = Halide::Buffer<short>(m_Parameter10.data(), 1024, 512, "Parameter10");
Halide::Func f_Parameter10("f_Parameter10"); f_Parameter10(var1, var2) = b_Parameter10(var1, var2);
Halide::Func f_step_Parameter10("f_step_Parameter10"); f_step_Parameter10() = m_step_Parameter10;
std::vector<Halide::Func> Parameter10 { f_Parameter10, f_step_Parameter10 };
...
auto b_Parameter17 = Halide::Buffer<short>(m_Parameter17.data(), 448, 4096, "Parameter17");
Halide::Func f_Parameter17("f_Parameter17"); f_Parameter17(var1, var2) = b_Parameter17(var1, var2);
Halide::Func f_step_Parameter17("f_step_Parameter17"); f_step_Parameter17() = m_step_Parameter17;
std::vector<Halide::Func> Parameter17 { f_Parameter17, f_step_Parameter17 };


auto b_Parameter19 = Halide::Buffer<short>(m_Parameter19.data(), 1024, 448, "Parameter19");
Halide::Func f_Parameter19("f_Parameter19"); f_Parameter19(var1, var2) = b_Parameter19(var1, var2);
Halide::Func f_step_Parameter19("f_step_Parameter19"); f_step_Parameter19() = m_step_Parameter19;
std::vector<Halide::Func> Parameter19 { f_Parameter19, f_step_Parameter19 };
...
std::vector<Halide::Func> Parameter22 { f_Parameter22, f_step_Parameter22 };
...
auto b_Parameter29 = Halide::Buffer<short>(m_Parameter29.data(), 384, 4096, "Parameter29");
Halide::Func f_Parameter29("f_Parameter29"); f_Parameter29(var1, var2) = b_Parameter29(var1, var2);
Halide::Func f_step_Parameter29("f_step_Parameter29"); f_step_Parameter29() = m_step_Parameter29;
std::vector<Halide::Func> Parameter29 { f_Parameter29, f_step_Parameter29 };


auto b_Parameter31 = Halide::Buffer<short>(m_Parameter31.data(), 1024, 384, "Parameter31");
Halide::Func f_Parameter31("f_Parameter31"); f_Parameter31(var1, var2) = b_Parameter31(var1, var2);
Halide::Func f_step_Parameter31("f_step_Parameter31"); f_step_Parameter31() = m_step_Parameter31;
std::vector<Halide::Func> Parameter31 { f_Parameter31, f_step_Parameter31 };
...
std::vector<Halide::Func> Parameter34 { f_Parameter34, f_step_Parameter34 };
...
auto b_Parameter41 = Halide::Buffer<short>(m_Parameter41.data(), 384, 4096, "Parameter41");
Halide::Func f_Parameter41("f_Parameter41"); f_Parameter41(var1, var2) = b_Parameter41(var1, var2);
Halide::Func f_step_Parameter41("f_step_Parameter41"); f_step_Parameter41() = m_step_Parameter41;
std::vector<Halide::Func> Parameter41 { f_Parameter41, f_step_Parameter41 };


auto b_Parameter43 = Halide::Buffer<short>(m_Parameter43.data(), 1024, 384, "Parameter43");
Halide::Func f_Parameter43("f_Parameter43"); f_Parameter43(var1, var2) = b_Parameter43(var1, var2);
Halide::Func f_step_Parameter43("f_step_Parameter43"); f_step_Parameter43() = m_step_Parameter43;
std::vector<Halide::Func> Parameter43 { f_Parameter43, f_step_Parameter43 };
...
std::vector<Halide::Func> Parameter46 { f_Parameter46, f_step_Parameter46 };
...
auto b_Parameter53 = Halide::Buffer<short>(m_Parameter53.data(), 192, 4096, "Parameter53");
Halide::Func f_Parameter53("f_Parameter53"); f_Parameter53(var1, var2) = b_Parameter53(var1, var2);
Halide::Func f_step_Parameter53("f_step_Parameter53"); f_step_Parameter53() = m_step_Parameter53;
std::vector<Halide::Func> Parameter53 { f_Parameter53, f_step_Parameter53 };


auto b_Parameter55 = Halide::Buffer<short>(m_Parameter55.data(), 592, 192, "Parameter55");
Halide::Func f_Parameter55("f_Parameter55"); f_Parameter55(var1, var2) = b_Parameter55(var1, var2);
Halide::Func f_step_Parameter55("f_step_Parameter55"); f_step_Parameter55() = m_step_Parameter55;
std::vector<Halide::Func> Parameter55 { f_Parameter55, f_step_Parameter55 };
...
std::vector<short> m_Parameter6;
float m_step_Parameter6;
std::vector<short> m_Parameter8;
float m_step_Parameter8;
std::vector<short> m_Parameter10;
float m_step_Parameter10;
...
std::vector<short> m_Parameter17;
float m_step_Parameter17;
std::vector<short> m_Parameter19;
float m_step_Parameter19;
std::vector<float> m_Constant429;
std::vector<short> m_Parameter22;
float m_step_Parameter22;
...
std::vector<short> m_Parameter29;
float m_step_Parameter29;
std::vector<short> m_Parameter31;
float m_step_Parameter31;
std::vector<float> m_Constant313;
std::vector<short> m_Parameter34;
float m_step_Parameter34;
...
std::vector<short> m_Parameter41;
float m_step_Parameter41;
std::vector<short> m_Parameter43;
float m_step_Parameter43;
std::vector<float> m_Constant197;
std::vector<short> m_Parameter46;
float m_step_Parameter46;
...
std::vector<short> m_Parameter53;
float m_step_Parameter53;
std::vector<short> m_Parameter55;
float m_step_Parameter55;
